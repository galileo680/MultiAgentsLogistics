...
class WarehouseAgent(BaseAgent):
    ...
    def handle_request(self, msg):
        ...
        self.post_office.broadcast(cfp_msg, self.transporter_ids)
    ...
    def handle_proposal(self, msg):
        ...
        if order_id in self.active_auctions:
            ...
            auction["proposals"].append({"agent_id": msg.sender_id, "cost": cost})
    ...
    def finalize_auctions(self):
        for order_id in list(self.active_auctions.keys()):
            ...
            if auction["pending_responses"] <= 0 and auction["proposals"]:
                ...
                msg_content = auction["content"]
                msg_content["cost"] = best_offer["cost"]
                ...
                self.post_office.send_message(accept_msg)
                ...
                for prop in auction["proposals"]:
                    if prop["agent_id"] != winner_id:
                        ...
                        self.post_office.send_message(reject_msg)
